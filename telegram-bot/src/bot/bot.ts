...
const COMMANDS: Record<Language, { command: string; description: string }[]> = {
  en: [
    ...
    { command: "faucet", description: "Free Sepolia test stablecoins" },
    { command: "rate", description: "Live FX rates" },
    { command: "liquidity", description: "Which pairs are swappable now" },
    ...
    { command: "importkey", description: "Import a wallet private key" },
  ...
  ja: [
    ...
    { command: "faucet", description: "Sepolia テストトークン入手" },
    { command: "rate", description: "リアルタイム為替レート" },
    { command: "liquidity", description: "スワップ可能なペアを確認" },
    ...
    { command: "exportkey", description: "秘密鍵をエクスポート" },
    { command: "importkey", description: "秘密鍵をインポート" },
